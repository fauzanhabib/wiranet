			...
			<div class="header-inner">
				...
				<nav role="navigation">
					<ul>
						...
						<li><a href="<?php echo base_url().'about'?>">Product</a></li>
						<li><a href="<?php echo base_url().'portfolio'?>">Service</a></li>
						<li><a href="<?php echo base_url().'artikel'?>">Client</a></li>
						<li><a href="<?php echo base_url().'gallery'?>">About us</a></li>
